...
if [ "$#" -lt 10 ]; then
    echo $#
    echo "wrong # parameters, want OpenSeesSimulation.sh --filenameBIM BIM.json --filenameSAM SAM.json --filenameEVENT EVENT.json --filenameEDP EDP.json --filenameSIM SIM.json <-r>
