...
int main(int argc, char **argv)
{
  ...
  // StandardEarthquakeEDP --filenameBIM file --filenameEVENT file? <-r>
  ...
  if (argc == 6) { 
    ...
    //
    // if -r we want to set EVENT file with random variables and events that just contain name
    //
  ...
  }  else { // if not -r we want to copy file to EVENT fileName
